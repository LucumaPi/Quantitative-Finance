...
void DiscreteBCatTimeZero(const Vector<double, long>& xMesh, const Vector<double, long>& yMesh, 
						  ...
						  NumericMatrix2<double, long>& Solution)
{
...
int main()
{
	...
	// the discrete domain
	//
	NumericMatrix2<double, long> MOld(xMesh.Size(), yMesh.Size(), xMesh.MinIndex(), yMesh.MinIndex());
...
//	cout << "kk " << repository.sizeThird() << endl;
	...
	NumericMatrix2<double, long> MNew(MOld);
