...
// DD 2006-5-20 Upwinding for convection terms
//
...
#include "numericmatrix.hpp" // 1 d vector now
//#include "tensor.cpp"
#include "tensor.cpp" // ditto
...
int main()
{
	...
	// the discrete domain
	//
	NumericMatrix<double, long> MOld(xMesh.Size(), yMesh.Size(), xMesh.MinIndex(), yMesh.MinIndex());
	...
	Tensor<double, long> repository(MOld.Rows(), MOld.Columns(), tensorSize);
