                     ...
                     int       nCmdShow)
{
	...
	while (szToken != NULL)
	{
		...
		{
			UnregisterServer(	CLSID_SDWInterfaceContainer,
									g_szVerIndProgID,
									g_szProgID) ;
	...
	// register the Factory, so COM knows how to create an SDWInterfaceContainer
	CoRegisterClassObject(	CLSID_SDWInterfaceContainer,
