...
int main()
{
	...
	// std::cout << "Scheme 1) Explicit 2) Implicit: ";
	// int ftype; std::cin >> ftype;
	...
	// std::cout << "Output: 1) Cell(matrix), 2) list of line graphs: ";
	...
	// if (choice == 2)
	// {
	// 	std::cout << "Frequency of output: "; int f; std::cin >> f;
