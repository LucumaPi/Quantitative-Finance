...
void Relation<D,R>::removeDomainElement(const D& d)
{
	...
	typename std::multimap<R, D>::iterator it, it2;
...
void Relation<D,R>::removeRangeElement(const R& r)
{
	...
	typename std::multimap<D,R>::iterator it, it2;
...
{ // Set of r for a d
	...
	// Simple but understandable solution
	typename std::multimap<D,R>::const_iterator it;
...
{ // Set of d for an r
	...
	typename std::multimap<R, D>::const_iterator it;
