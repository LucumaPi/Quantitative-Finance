...
\DoxyCodeLine{00017 }
\DoxyCodeLine{00018 \textcolor{preprocessor}{\#include "\mbox{\hyperlink{MultiAssetPayoffStrategy_8hh}{MultiAssetPayoffStrategy.hh}}"}}
...
\DoxyCodeLine{\Hypertarget{MultiAssetFactory_8hh_source_l00026}\mbox{\hyperlink{classMultiAssetFactory_a2a3e41943a6d51f6c56ed746db443a86}{00026}}         \mbox{\hyperlink{classMultiAssetFactory_a2a3e41943a6d51f6c56ed746db443a86}{MultiAssetFactory}}()}
\DoxyCodeLine{00027         \{}
...
\DoxyCodeLine{00039         \}}
\DoxyCodeLine{00040 }
\DoxyCodeLine{\Hypertarget{MultiAssetFactory_8hh_source_l00041}\mbox{\hyperlink{classMultiAssetFactory_af557ef4e09d2fd13505bd932e1c17e78}{00041}}         \textcolor{keyword}{virtual} \mbox{\hyperlink{classMultiAssetPayoffStrategy}{MultiAssetPayoffStrategy}}* \mbox{\hyperlink{classMultiAssetFactory_af557ef4e09d2fd13505bd932e1c17e78}{create}}(\textcolor{keywordtype}{int} \mbox{\hyperlink{TestImpliedVolatility_8cc_a6cbb82a21dec4c4f36c3f78340be64de}{N}})}
\DoxyCodeLine{00042         \{}
\DoxyCodeLine{00043 }
...
\DoxyCodeLine{00059         \}}
\DoxyCodeLine{00060 }
\DoxyCodeLine{\Hypertarget{MultiAssetFactory_8hh_source_l00061}\mbox{\hyperlink{classMultiAssetFactory_ac119d81cfec42e83368f632e261e59f1}{00061}}         \textcolor{keywordtype}{void} \mbox{\hyperlink{classMultiAssetFactory_ac119d81cfec42e83368f632e261e59f1}{display}}()}
...
\DoxyCodeLine{00086 }
\DoxyCodeLine{00087     std::cout << \textcolor{stringliteral}{"Strike K: "}; \textcolor{keywordtype}{double} \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}; std::cin >> \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}};}
\DoxyCodeLine{00088     std::cout << \textcolor{stringliteral}{"Call +1, Put -\/1: "}; \textcolor{keywordtype}{double} w; std::cin >> w;}
\DoxyCodeLine{00089     std::cout << \textcolor{stringliteral}{"Max(max) 1 or Max(min) 2: "}; \textcolor{keywordtype}{int} \mbox{\hyperlink{namespacePayoffNamespace_a39ee14e55dbe34eb4f30330edd487f84}{type}}; std::cin >> \mbox{\hyperlink{namespacePayoffNamespace_a39ee14e55dbe34eb4f30330edd487f84}{type}};}
\DoxyCodeLine{00090 }
\DoxyCodeLine{00091     \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{classRainbowStrategy}{RainbowStrategy}}(\mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}, w, \mbox{\hyperlink{namespacePayoffNamespace_a39ee14e55dbe34eb4f30330edd487f84}{type}});}
\DoxyCodeLine{00092 \}}
\DoxyCodeLine{00093 }
\DoxyCodeLine{00094 }
...
\DoxyCodeLine{00100     std::cout << \textcolor{stringliteral}{"Strike K: "}; \textcolor{keywordtype}{double} \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}; std::cin >> \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}};}
...
\DoxyCodeLine{00108     \}}
\DoxyCodeLine{00109 }
\DoxyCodeLine{00110     \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{classBasketStrategy}{BasketStrategy}}(\mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}, w, w1, w2);}
\DoxyCodeLine{00111 }
\DoxyCodeLine{00112 \}}
\DoxyCodeLine{00113 }
...
\DoxyCodeLine{00117 }
\DoxyCodeLine{00118     std::cout << \textcolor{stringliteral}{"Strike(cash) K: "}; \textcolor{keywordtype}{double} \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}; std::cin >> \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}};}
\DoxyCodeLine{00119     std::cout << \textcolor{stringliteral}{"Best +1, Worst -\/1: "}; \textcolor{keywordtype}{double} w; std::cin >> w;}
\DoxyCodeLine{00120 }
\DoxyCodeLine{00121     \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{classBestWorstStrategy}{BestWorstStrategy}}(\mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}, w);}
\DoxyCodeLine{00122 \}}
\DoxyCodeLine{00123 }
...
\DoxyCodeLine{00128 }
\DoxyCodeLine{00129     std::cout << \textcolor{stringliteral}{"Strike K: "}; \textcolor{keywordtype}{double} \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}; std::cin >> \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}};}
\DoxyCodeLine{00130     std::cout << \textcolor{stringliteral}{"Call +1, Put -\/1: "}; \textcolor{keywordtype}{double} w; std::cin >> w;}
\DoxyCodeLine{00131 }
\DoxyCodeLine{00132     \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{classQuotientStrategy}{QuotientStrategy}}(\mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}, w);}
\DoxyCodeLine{00133 \}}
\DoxyCodeLine{00134 }
...
\DoxyCodeLine{00138 }
\DoxyCodeLine{00139     std::cout << \textcolor{stringliteral}{"Strike K in foreign currency: "}; \textcolor{keywordtype}{double} \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}; std::cin >> \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}};}
...
\DoxyCodeLine{00142 }
\DoxyCodeLine{00143     \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{classQuantoStrategy}{QuantoStrategy}}(\mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}, w, fer);}
\DoxyCodeLine{00144 \}}
\DoxyCodeLine{00145 }
...
\DoxyCodeLine{00149 }
\DoxyCodeLine{00150     std::cout << \textcolor{stringliteral}{"Strike K: "}; \textcolor{keywordtype}{double} \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}; std::cin >> \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}};}
...
\DoxyCodeLine{00153     std::cout << \textcolor{stringliteral}{"Value 'b' < 0: "}; \textcolor{keywordtype}{double} \mbox{\hyperlink{namespaceNSEuropeanOption_a6b26f4d79c6b43133be664e2eb229fff}{b}}; std::cin >> \mbox{\hyperlink{namespaceNSEuropeanOption_a6b26f4d79c6b43133be664e2eb229fff}{b}};}
\DoxyCodeLine{00154 }
\DoxyCodeLine{00155     \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{classSpreadStrategy}{SpreadStrategy}}(w, \mbox{\hyperlink{namespacePayoffNamespace_ab501f4bdb2c74995b98b666056c671fb}{K}}, a, \mbox{\hyperlink{namespaceNSEuropeanOption_a6b26f4d79c6b43133be664e2eb229fff}{b}});}
\DoxyCodeLine{00156 }
\DoxyCodeLine{00157 \}}
\DoxyCodeLine{00158 }
\DoxyCodeLine{00159 }
