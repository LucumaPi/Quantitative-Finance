...
#ifndef AssocMatrix_HH
#define AssocMatrix_HH
...
template <class V, class AI1 = std::string, class AI2 = std::string> class AssocMatrix
...
#include "../../src/AssocMatrix.cc"
#endif	// AssocMatrix_HH