...
#ifndef NonlinearSolver_HH
#define NonlinearSolver_HH
#include <iostream>
#include <cmath>
#include <cassert>
...
public:
		...
		NonlinearSolver() {}
		NonlinearSolver& operator = (const NonlinearSolver& n2) { return *this;}
...
L1:
	...
	void printStatistics() 
	{
		...
		std::cout << "Interval containing value: (" << aCurrent << ","
											<< bCurrent << ")\n";
		std::cout << "Value: " << m << std::endl;
		std::cout << "Number of iterations (actual): " << n << std::endl;
		std::cout << "Number of iterations (scheduled): " << estimate() << std::endl;
	}
	...
	{ // Estimates the number of needed iterations
			...
			double tmp = (b - a) / tol;
			double val = 1.0 + (std::log(tmp)/std::log(2.0));
...
L1:
	...
	void printStatistics() const
	{
		...
		std::cout << "Value: " << xCurrent << std::endl;
		std::cout << "Number of iterations (actual): " << n << std::endl;
	}
