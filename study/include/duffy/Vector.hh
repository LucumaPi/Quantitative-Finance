...
public:
	...
	friend Vector<V, I, S> operator + (const Vector<V1, I1, S1>& v,const V1& a);	// Add v to every element

	template <class V1, class I1, class S1>
	friend Vector<V, I, S> operator + (const V1& a,	const Vector<V1, I1, S1>& v);

	template <class V1, class I1, class S1>
	friend Vector<V, I, S> operator - (const Vector<V1, I1, S1>& v, const V1& a);	// Subtract v from every element

	template <class V1, class I1, class S1>
	friend Vector<V, I, S> operator - (const V1& a,	const Vector<V1, I1, S1>& v);

	template <class V1, class I1, class S1>
	friend Vector<V, I, S> operator * (const Vector<V1, I1, S1>& v, 
										const V1& a);	// Multiply every element by v
