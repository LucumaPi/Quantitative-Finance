...
//			(3D case)
//			Topper 2005, page 197(Case Study, Basket Option)
//			(2D case)
...
#ifndef INSTRUMENTNEW_HH
#define INSTRUMENTNEW_HH
...
L1:
		...
		std::cout << "Volatility 1: ";
		std::cin >> dsig1;

		std::cout << "Volatility 2: ";
		std::cin >> dsig2;
		...
		std::cout << "First Far Field: ";
		std::cin >> dSMax1;
		std::cout << "Second Far Field: ";
		std::cin >> dSMax2;
		...
		std::cout << "Is this correct, carry on?";
		char c; std::cin >> c;
		if (c != 'y' && c != 'Y')
		{
			goto L1;
