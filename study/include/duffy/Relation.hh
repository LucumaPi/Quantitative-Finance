...
private:
	...
	std::multimap<D, R> f;		// The mapping itself
	std::multimap<R, D> finv;	// The inverse mapping
...
public:
	...
	typedef typename std::multimap<D, R>::iterator iterator;
	typedef typename std::multimap<D, R>::const_iterator const_iterator;
	...
	typedef typename std::multimap<R, D>::iterator iteratorInv;
	typedef typename std::multimap<R, D>::const_iterator const_iteratorInv;
