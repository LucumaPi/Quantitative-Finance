...
template <class V, class AI = std::string> class AssocArray
{ // Note that the first index is the value and second index is 
  // 'associative' key

private: 
		std::map<AI,V> str;	// The list of associative values, e.g. strings
...
public:
	...
	typedef typename std::map<AI,V>::iterator iterator;
	typedef typename std::map<AI,V>::const_iterator const_iterator;
