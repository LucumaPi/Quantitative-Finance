...
// 2006-1-20 DD to readers: are formulae OK?
//
// (C) Datasim Education BV 1998 - 2006

#ifndef MultiAssetPayoffStrategy_hh
#define MultiAssetPayoffStrategy_hh

#include "Inequalities.hh"	// Chapter 2
...
public:
		...
		double payoff(double S1, double S2) const
		{
			...
			return Max (w1*(S1-K1), w2*(S2-K2), 0.0);
